...
class FileReceiver
{
     ...
     */
    public function __construct($fileIndex, Request $request, $handlerClass, $chunkStorage = null, $config = null, $fileArrayIndex = null)
    {
        $this->request = $request;
        $this->file = is_null($fileArrayIndex) ? $request->file($fileIndex) : $request->file($fileIndex)[$fileArrayIndex];
